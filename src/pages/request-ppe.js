    ...
    return (
      <div>
        ...
        <div className="container">
          <div class="jumbotron">
            <h1 class="display-4">Request PPE</h1>
            <p class="lead">
              This Form is for Healthcare Workers to Request PPE to be donated to their facility.
              <br /> <br />
              As of 04/03/2020 our focus is primarily on manufacturing and delivering Face Shields.
              We are in the process of beginning to manufacture Intubation boxes and are organizing
              suppliers to deliver other forms of PPE in the near future.
              <br /> <br />
              Our team will contact you within 24-48 hours with information on shipping. We 
              typically have the capacity to ship one hospital with 50-100 shields at a time. 
              Currently, we can only ship within the U.S.
              <br /> <br />
              Because of the high demand we've had to support a majority of this project out of
              pocket, it would mean a lot if you could share our cause with others to help support
              this project further: <a href="https://www.gofundme.com/f/provide-our-heroes-ppe-for-hospitals">https://www.gofundme.com/f/provide-our-heroes-ppe-for-hospitals</a>
              <br /> <br />
